package co.id.bismalabs.mypreloaddata.database
...
import co.id.bismalabs.mypreloaddata.database.DatabaseContract.MahasiswaColumns.Companion.NAMA
import co.id.bismalabs.mypreloaddata.database.DatabaseContract.MahasiswaColumns.Companion.NIM
import co.id.bismalabs.mypreloaddata.database.DatabaseContract.TABLE_NAME
